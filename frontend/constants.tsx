...
export const PRODUCTS: Product[] = [
  ...
  { id: 'neck-02', isBestseller: true, name: 'Antique Peacock Rani Haar', category: Category.NECKLACES, price: 3200, description: 'Traditional long necklace featuring exquisite peacock motifs and an antique gold matte finish.', imageUrl: '/image/antique-peacock-rani-haar-1.png', hoverImageUrl: '/image/antique-peacock-rani-haar-2.png', arAsset: '/ar-assets/rani-haar.png', detailImages: ['/image/antique-peacock-rani-haar-1.png', '/image/antique-peacock-rani-haar-2.png', '/Videos/Antique Peacock Rani Haar video.mp4'] },
  { id: 'neck-03', name: 'Victorian Emerald String', category: Category.NECKLACES, price: 2850, description: 'Deep green emerald cut.', imageUrl: '/image/victorian-emerald-string-1.png', hoverImageUrl: '/image/victorian-emerald-string-2.png', detailImages: ['/image/victorian-emerald-string-1.png', '/image/victorian-emerald-string-2.png', '/Videos/Victorian Emerald String video.mp4'] },
  { id: 'neck-04', name: 'Jaipur Meenakari Set', category: Category.NECKLACES, price: 3100, description: 'Hand-painted enamel work.', imageUrl: '/image/jaipur-meenakari-set-1.png', hoverImageUrl: '/image/jaipur-meenakari-set-2.png', detailImages: ['/image/jaipur-meenakari-set-1.png', '/image/jaipur-meenakari-set-2.png'] },
  { id: 'neck-05', name: 'Temple Gold Choker', category: Category.NECKLACES, price: 2900, description: 'Divine antique finish.', imageUrl: '/image/temple-gold-choker-1.png', hoverImageUrl: '/image/temple-gold-choker-2.png', detailImages: ['/image/temple-gold-choker-1.png', '/image/temple-gold-choker-2.png'] },
  { id: 'neck-06', name: 'Oxidized Tribal Mala', category: Category.NECKLACES, price: 1800, description: 'Bohemian Jaipur vibes.', imageUrl: '/image/oxidized-tribal-mala-1.png', hoverImageUrl: '/image/oxidized-tribal-mala-2.png', detailImages: ['/image/oxidized-tribal-mala-1.png', '/image/oxidized-tribal-mala-2.png'] },
  { id: 'neck-07', name: 'Bridal Kundan Layer', category: Category.NECKLACES, price: 5500, description: 'Majestic wedding look.', imageUrl: '/image/bridal-kundan-layer.jpg', hoverImageUrl: '/image/bridal-kundan-set-1.png', detailImages: ['/image/bridal-kundan-layer.jpg'] },
  { id: 'neck-08', name: 'Polki Statement Set', category: Category.NECKLACES, price: 4200, description: 'Heritage uncut stones.', imageUrl: '/image/polki-necklaces-1.png', hoverImageUrl: '/image/polki-statement-set-2.png', detailImages: ['/image/polki-statement-set-2.png'] },
  { id: 'neck-09', name: 'Festive Gold String', category: Category.NECKLACES, price: 2400, description: 'Elegant daily grace.', imageUrl: '/image/festive-gold-string-1.png', hoverImageUrl: '/image/festive-gold-string-2.png', detailImages: ['/image/festive-gold-string-1.png', '/image/festive-gold-string-2.png', '/Videos/Festive Gold String video.mp4'] },

  // --- EARRINGS (5 Items) ---
  { id: 'ear-01', isBestseller: true, name: 'Classic Jhumka Shine', category: Category.TEMPLE, price: 1250, description: 'Gold plated bells.', imageUrl: '/image/classic-jhumka-shine-1.jpg', hoverImageUrl: '/image/classic-jhumka-shine-3.png', arAsset: '/ar-assets/jhumka.png', detailImages: ['/image/classic-jhumka-shine-1.jpg', '/Videos/Classic Jhumka Shine video.mp4', '/image/classic-jhumka-shine-3.png'] },
  ...
  { id: 'ear-04', isBestseller: true, name: 'Heritage Drop Earrings', category: Category.KUNDAN, price: 1400, description: 'Regal kundan drops.', imageUrl: '/image/heritage-drop-earrings.png', hoverImageUrl: '/image/heritage-drop-earrings-box.jpg', arAsset: '/ar-assets/kundan-drop.png', detailImages: ['/image/heritage-drop-earrings.png', '/Videos/Heritage Drop Earrings video.mp4', '/image/heritage-drop-earrings-box.jpg'] },
  ...
  // --- KUNDAN (3 Items) ---
  { id: 'kun-01', name: 'Bridal Kundan Set', category: Category.KUNDAN, price: 6200, description: 'Complete bridal look.', imageUrl: '/image/bridal-kundan-set-1.png', hoverImageUrl: '/image/bridal-kundan-layer.jpg', detailImages: ['/image/bridal-kundan-set-1.png'] },
  { id: 'kun-02', name: 'Kundan Choker', category: Category.KUNDAN, price: 3400, description: 'Elegant neck piece.', imageUrl: '/image/kundan-cocktail-choker-1.png', hoverImageUrl: '/image/kundan-cocktail-choker-2.png', detailImages: ['/image/kundan-cocktail-choker-1.png', '/image/kundan-cocktail-choker-2.png'] },
  { id: 'kun-03', isBestseller: true, name: 'Meenakari Kundan Studs', category: Category.KUNDAN, price: 4800, description: 'Colorful enamel work.', imageUrl: '/image/meenakari-kundan-studs-new.jpg', hoverImageUrl: '/image/meenakari-kundan-studs-1.png', detailImages: ['/image/meenakari-kundan-studs-new.jpg', '/Videos/Meenakari Kundan Studs video.mp4', '/image/meenakari-kundan-studs-1.png'] },

  // --- RINGS (2 Items) ---
  { id: 'ring-01', name: 'Maharani Polki Ring', category: Category.RINGS, price: 1100, description: 'Oversized statement.', imageUrl: '/image/maharani-polki-ring-1.png', hoverImageUrl: '/image/maharani-polki-ring.png', detailImages: ['/image/maharani-polki-ring-1.png', '/image/maharani-polki-ring.png'] },
  { id: 'ring-02', isBestseller: true, name: 'Sparkling AD Band', category: Category.RINGS, price: 650, description: 'Sleek everyday band.', imageUrl: '/image/sparkling-ad-band-3.png', hoverImageUrl: '/image/sparkling-ad-band-1.png', detailImages: ['/Videos/Sparkling AD Band video.mp4', '/image/sparkling-ad-band-1.png', '/image/sparkling-ad-band-2.png', '/image/sparkling-ad-band-3.png'] },

  // --- BANGLES (5 Items) ---
  { id: 'ban-01', isBestseller: true, name: 'Gajra Gold Bangles Set', category: Category.BANGLES, price: 1100, description: 'Micro-plated gold.', imageUrl: '/image/gajra-gold-bangles-set.png', hoverImageUrl: '/image/gajra-gold-bangles-set-2.png', detailImages: ['/image/gajra-gold-bangles-set.png', '/image/gajra-gold-bangles-set-2.png', '/Videos/Gajra Gold Bangles Set video.mp4'] },
